...
<section class="content">
 ...
 <?php $id=$employee[0]->id;?>
 <div class="container-fluid">
   <form action="<?php echo e(route('update_employee',['id'=> $id])); ?>" method="post" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
                                            ...
                                            <div class="row clearfix" style="margin-bottom:-30px">
                                              ...
                                              <div class="col-sm-6 pl-0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control btn-round brder" name="username" value="<?php echo e($employee[0]->username); ?>" placeholder="">
                                                </div>
                                      ...
                                      <div class="row clearfix" style="margin-bottom:-30px">
                                        ...
                                        <div class="col-sm-6 pl-0">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control btn-round brder" name="email" value="<?php echo e($employee[0]->email); ?>" placeholder="">
                                          </div>
                                                  ...
                                                  <div class="row clearfix" style="margin-bottom:-30px">
                                                    ...
                                                    <div class="col-sm-6 pl-0">
                                                      ...
                                                      <div class="form-group">
                                                          ...
                                                          <input type="text" class="form-control btn-round brder" value="<?php echo e($employee[0]->phone_no); ?>" name="phone_no" placeholder="">
                                                      </div>
                                                                ...
                                                                <div class="col-sm-6 pl-0">
                                                                  ...
                                                                  <div class="form-group">
                                                                      ...
                                                                      <select type="text" class="form-control btn-round brder" name="gender" placeholder="">
                                                                        <option value="Male" <?php echo e($employee[0]->gender == 'Male' ? 'selected' : ''); ?>>Male</option>
                                                                        <option value="Female" <?php echo e($employee[0]->gender == 'Female' ? 'selected' : ''); ?>>Female</option>
                                                                        <option value="Other" <?php echo e($employee[0]->gender == 'Other' ? 'selected' : ''); ?>>Other</option>
                                                                      </select>
                                                                  </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\employee-data\resources\views/edit_employee.blade.php ENDPATH**/ ?>